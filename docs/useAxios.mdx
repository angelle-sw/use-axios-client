...
These response values are returned by the `useAxios` hook, and can be used to handle each state of your request. It also provides several functions that allow you to interact with the request in an imperative way if needed.
